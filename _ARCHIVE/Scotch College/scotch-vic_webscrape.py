"""
Scotch College - Web Scraper (00624A).
Data sources: https://www.scotch.vic.edu.au/admissions/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00624A"
PROVIDER_NAME = "Scotch College"
...
INTL_URL = "https://www.scotch.vic.edu.au/admissions/international"
