"""
SCEI (Southern Cross Education Institute) — CSV-driven (provider 02934D).
No Cloudflare. Next.js with SSR but CRICOS JS-loaded. Strategy: CSV-driven.
"""
import sys, re, csv
...
PROVIDER_NAME = 'SCEI (Southern Cross Education Institute)'
...
def main():
    ...
    out = [{
        ...
        'source': 'register', 'note': 'CSV-driven (Next.js SSR no CRICOS)',
    } for r in rows]
