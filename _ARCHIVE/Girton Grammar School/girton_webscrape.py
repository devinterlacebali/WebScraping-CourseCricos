"""
Girton Grammar School - Web Scraper (01100K).
Data sources: https://www.girton.vic.edu.au/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01100K"
PROVIDER_NAME = "Girton Grammar School"
...
INTL_URL = "https://www.girton.vic.edu.au/international"
WEBSITE = "https://www.girton.vic.edu.au"
