#!/usr/bin/env python3
"""
Webscraper for Anglican Church Grammar School (00487E)
CRICOS Provider: 00487E
Website: www.churchie.com.au
"""
...
PROVIDER_CODE = "00487E"
PROVIDER_NAME = r"Anglican Church Grammar School"
SLUG = "churchie"
...
CSV_COURSES = [
  {
    "cricos": "0100111",
    "name": "Junior Secondary Studies (Years 7-10) Boys Only",
    "fee": "$380,683.00",
    "non_fee": "$177,123.00",
    "duration": "208"
  },
  {
    "cricos": "0100112",
    "name": "Senior Secondary Studies (Years 11-12) Boys Only",
    "fee": "$191,781.00",
    "non_fee": "$92,501.00",
    "duration": "104"
  },
  {
    "cricos": "0100118",
    "name": "International Baccalaureate Diploma (Years 11-12) Boys Only",
    "fee": "$190,070.00",
    "non_fee": "$90,790.00",
    "duration": "104"
  },
  {
    "cricos": "112749A",
    "name": "International Baccalaureate Primary Years Program (Prep to Year 6)",
    "fee": "$303,823.00",
    "non_fee": "$12,199.00",
    "duration": "364"
  }
