"""
Rhodes College - Web Scraper (02992E).
Data sources: https://www.rhodescollege.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "02992E"
PROVIDER_NAME = "Rhodes College"
...
INTL_URL = "https://www.rhodescollege.vic.edu.au/courses"
WEBSITE = "https://www.rhodescollege.vic.edu.au"
