"""
Strategix Training Group — CSV-driven (provider 03623M).
Cloudflare. No sitemap. Course routes 404. Strategy: CSV-driven.
"""
import sys, re, csv
...
PROVIDER_CODE = '03623M'
PROVIDER_NAME = 'Strategix Training Group'
...
def main():
    ...
    out = [{
        ...
        'source': 'register', 'note': 'CSV-driven (no SSR)',
    } for r in rows]
