"""
The Knox School — Web scrape (00151G).
"""
...
SITE = "https://www.knox.vic.edu.au/enrolment/international-enrolments/"
    ...
    with open(REGISTER_CSV, encoding="utf-8-sig") as f:
        for rec in csv.DictReader(f):
            ...
            rows.append({
                ...
                "course_description": "<h4>Course Overview</h4><p>The Knox School - International Student Program. Co-educational, ELC to Year 12.</p>",
                "entry_requirements": "AEAS test results. Interview with Principal. Previous academic records required.",
                "apply_form": "https://www.knox.vic.edu.au/enrolment/",
                "source": "register", "note": "International fee information not in HTML. Fees in PDF schedule. Using CSV register data.",
            })
