"""
Melbourne City Institute of Education - Web Scraper (03024A).
Data sources: https://www.mcie.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03024A"
PROVIDER_NAME = "Melbourne City Institute of Education"
...
INTL_URL = "https://www.mcie.edu.au/courses"
WEBSITE = "https://www.mcie.edu.au"
