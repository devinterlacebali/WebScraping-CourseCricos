"""
Loyola College - Web Scraper (00558F).
Data sources: https://www.loyola.vic.edu.au/international-students
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00558F"
PROVIDER_NAME = "Loyola College"
...
INTL_URL = "https://www.loyola.vic.edu.au/international-students"
