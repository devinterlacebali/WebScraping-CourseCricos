#!/usr/bin/env python3
"""
Webscraper for St Michael_s Collegiate School (00482K)
CRICOS Provider: 00482K
...
PROVIDER_CODE = "00482K"
PROVIDER_NAME = r"St Michael_s Collegiate School"
SLUG = "collegiate"
...
CSV_COURSES = [
  {
    "cricos": "028838A",
    "name": "Secondary Studies Years 7 - 9",
    "fee": "$97,800.00",
    "non_fee": "$0.00",
    "duration": "150"
  },
  {
    "cricos": "029255E",
    "name": "Secondary Studies Years 10 - 12",
    "fee": "$97,800.00",
    "non_fee": "$0.00",
    "duration": "150"
  },
  {
    "cricos": "088056A",
    "name": "Primary Years Kindergarten - 6",
    "fee": "$185,200.00",
    "non_fee": "$0.00",
    "duration": "410"
  },
  {
    "cricos": "088057M",
    "name": "Secondary School Year 7 - 10",
    "fee": "$130,400.00",
    "non_fee": "$0.00",
    "duration": "202"
  },
  {
    "cricos": "088058K",
    "name": "Secondary School Year 11 - 12",
    "fee": "$65,200.00",
    "non_fee": "$0.00",
    "duration": "98"
  }
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.collegiate.tas.edu.au",
