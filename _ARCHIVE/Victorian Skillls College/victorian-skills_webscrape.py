"""
Victorian Skillls College - Web Scraper (04354H).
Data sources: https://www.victorianskills.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "04354H"
PROVIDER_NAME = "Victorian Skillls College"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "victorian-skills"
...
INTL_URL = "https://www.victorianskills.vic.edu.au/courses"
WEBSITE = "https://www.victorianskills.vic.edu.au"
