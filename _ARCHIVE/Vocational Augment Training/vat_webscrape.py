"""
Vocational Augment Training - Web Scraper (04305F).
Data sources: https://www.vat.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "04305F"
PROVIDER_NAME = "Vocational Augment Training"
...
INTL_URL = "https://www.vat.vic.edu.au/courses"
WEBSITE = "https://www.vat.vic.edu.au"
