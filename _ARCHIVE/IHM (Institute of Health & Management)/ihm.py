"""
IHM (Institute of Health & Management) — CSV-driven (provider 03407G).
No Cloudflare. WordPress site. Strategy: CSV-driven.
"""
import sys, re, csv
...
PROVIDER_CODE = '03407G'
PROVIDER_NAME = 'IHM (Institute of Health & Management)'
...
def main():
    ...
    out = [{
        ...
        'source': 'register', 'note': 'CSV-driven (WordPress)',
    } for r in rows]
