"""
Melbourne City College Australia - Web Scraper (03592B).
Data sources: https://www.melbournecitycollege.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03592B"
PROVIDER_NAME = "Melbourne City College Australia"
...
INTL_URL = "https://www.melbournecitycollege.edu.au/courses"
WEBSITE = "https://www.melbournecitycollege.edu.au"
