"""
Australis Business School - Web Scraper (04289A).
Data sources: https://www.australis.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "04289A"
PROVIDER_NAME = "Australis Business School"
...
INTL_URL = "https://www.australis.vic.edu.au/courses"
WEBSITE = "https://www.australis.vic.edu.au"
