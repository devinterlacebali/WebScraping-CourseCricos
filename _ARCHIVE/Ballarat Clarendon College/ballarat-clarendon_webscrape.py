"""
Ballarat Clarendon College - Web Scraper (00557G).
Data sources: https://www.clarendon.vic.edu.au/enrolment/international-students
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00557G"
PROVIDER_NAME = "Ballarat Clarendon College"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "ballarat-clarendon"
...
INTL_URL = "https://www.clarendon.vic.edu.au/enrolment/international-students"
WEBSITE = "https://www.clarendon.vic.edu.au"
