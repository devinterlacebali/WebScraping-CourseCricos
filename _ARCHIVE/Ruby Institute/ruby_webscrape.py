"""
Ruby Institute - Web Scraper (03723G).
Data sources: https://www.ruby.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03723G"
PROVIDER_NAME = "Ruby Institute"
...
INTL_URL = "https://www.ruby.vic.edu.au/courses"
WEBSITE = "https://www.ruby.vic.edu.au"
