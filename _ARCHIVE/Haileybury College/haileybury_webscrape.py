"""
Haileybury College - Web Scraper (00649C).
Data sources: https://www.haileybury.vic.edu.au/enrolment/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00649C"
PROVIDER_NAME = "Haileybury College"
...
INTL_URL = "https://www.haileybury.vic.edu.au/enrolment/international"
WEBSITE = "https://www.haileybury.vic.edu.au"
