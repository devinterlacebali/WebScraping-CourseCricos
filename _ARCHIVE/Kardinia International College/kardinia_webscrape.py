"""
Kardinia International College - Web Scraper (01502C).
Data sources: https://www.kardinia.vic.edu.au/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01502C"
PROVIDER_NAME = "Kardinia International College"
...
INTL_URL = "https://www.kardinia.vic.edu.au/international"
