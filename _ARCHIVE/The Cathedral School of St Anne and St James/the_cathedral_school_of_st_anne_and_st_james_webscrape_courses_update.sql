...
UPDATE courses SET
    ...
    apply_form = 'https://www.cathedral.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '072635B';
UPDATE courses SET
    course_description = '<h4>Junior Secondary Years 7-10</h4> <p><strong>Level:</strong> Junior Secondary Studies</p>',
    course_duration_per_week = 208,
    offshore_tuition_fee = 133960,
    onshore_tuition_fee = NULL,
    enrolment_fee = 103029,
    materials_fee = NULL,
    entry_requirements = '<h4>Entry Requirements</h4><p>Academic transcripts, English language proficiency assessment, school interview</p>',
    apply_form = 'https://www.cathedral.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '099589C';
UPDATE courses SET
    ...
    apply_form = 'https://www.cathedral.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '099590K';