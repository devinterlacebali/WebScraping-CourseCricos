#!/usr/bin/env python3
"""
Webscraper for Lourdes Hill College (00503K)
CRICOS Provider: 00503K
Website: www.lhc.qld.edu.au
"""
...
PROVIDER_CODE = "00503K"
PROVIDER_NAME = r"Lourdes Hill College"
SLUG = "lhc"
...
CSV_COURSES = [
  {
    "cricos": "088020B",
    "name": "Senior Secondary Years 11-12 Girls Only",
    "fee": "$118,873.00",
    "non_fee": "$55,633.00",
    "duration": "104"
  },
  {
    "cricos": "115592D",
    "name": "Primary School Studies Years 5-6 Girls Only",
    "fee": "$63,250.00",
    "non_fee": "$6,650.00",
    "duration": "104"
  },
  {
    "cricos": "115593C",
    "name": "Junior Secondary Studies Years 7-10 Girls Only",
    "fee": "$229,111.00",
    "non_fee": "$106,231.00",
    "duration": "208"
  }
