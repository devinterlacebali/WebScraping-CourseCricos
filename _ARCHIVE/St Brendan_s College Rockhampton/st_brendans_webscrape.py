#!/usr/bin/env python3
"""
Webscraper for St Brendan_s College Rockhampton (00506G)
CRICOS Provider: 00506G
...
PROVIDER_CODE = "00506G"
PROVIDER_NAME = r"St Brendan_s College Rockhampton"
SLUG = "st_brendans"
...
CSV_COURSES = [
  ...
  {
    "cricos": "082647D",
    "name": "Secondary Junior Years 7-10 Boys & Girls",
    "fee": "$170,062.00",
    "non_fee": "$74,668.00",
    "duration": "208"
  }
