-- QLD Provider: Moreton Bay Boys College (03772J)
-- Courses sourced from CRICOS register (5 courses)

UPDATE provider_institution SET
    intake_date = 'January, July',
    updated_at = NOW()
WHERE cricos_provider_code = '03772J';
...
UPDATE courses SET
    ...
    apply_form = 'https://www.mbbc.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '0100275';
UPDATE courses SET
    ...
    apply_form = 'https://www.mbbc.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '0101302';
UPDATE courses SET
    ...
    onshore_tuition_fee = NULL,
    enrolment_fee = 117687,
    materials_fee = NULL,
    entry_requirements = '<h4>Entry Requirements</h4><p>Academic transcripts, English language proficiency assessment, school interview</p>',
    apply_form = 'https://www.mbbc.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '103140J';
UPDATE courses SET
    ...
    apply_form = 'https://www.mbbc.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '112308D';
UPDATE courses SET
    ...
    apply_form = 'https://www.mbbc.qld.edu.au',
    updated_at = NOW()
WHERE cricos_course_code = '116206M';