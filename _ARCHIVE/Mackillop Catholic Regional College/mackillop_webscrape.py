"""
Mackillop Catholic Regional College - Web Scraper (01220B).
Data sources: https://www.mackillop.vic.edu.au/enrolment/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01220B"
PROVIDER_NAME = "Mackillop Catholic Regional College"
...
INTL_URL = "https://www.mackillop.vic.edu.au/enrolment/international"
