#!/usr/bin/env python3
"""
Webscraper for Downlands College Ltd (00494F)
CRICOS Provider: 00494F
...
PROVIDER_CODE = "00494F"
PROVIDER_NAME = r"Downlands College Ltd"
SLUG = "downlands"
...
CSV_COURSES = [
  {
    "cricos": "004867E",
    "name": "Secondary Senior Yrs 11-12 Girls & Boys",
    "fee": "$102,000.00",
    "non_fee": "$47,000.00",
    "duration": "102"
  },
  {
    "cricos": "082457K",
    "name": "Secondary Junior Years 7-10 Girls and Boys",
    "fee": "$194,000.00",
    "non_fee": "$89,000.00",
    "duration": "208"
  }
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.downlands.qld.edu.au",
