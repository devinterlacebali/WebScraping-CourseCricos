#!/usr/bin/env python3
"""
Webscraper for St Augustine_s College Cairns (00509D)
CRICOS Provider: 00509D
Website: www.sac.qld.edu.au
"""
...
PROVIDER_CODE = "00509D"
PROVIDER_NAME = r"St Augustine_s College Cairns"
SLUG = "sac"
...
CSV_COURSES = [
  ...
  {
    "cricos": "082949A",
    "name": "Secondary Junior Years 7-10 Boys Only",
    "fee": "$194,993.00",
    "non_fee": "$88,972.00",
    "duration": "208"
  }
