"""
MELBOURNE INSTITUTE OF TRAINING AND EDUCATION - Web Scraper (03976H).
Data sources: https://www.mite.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03976H"
PROVIDER_NAME = "MELBOURNE INSTITUTE OF TRAINING AND EDUCATION"
...
INTL_URL = "https://www.mite.edu.au/courses"
WEBSITE = "https://www.mite.edu.au"
