#!/usr/bin/env python3
"""
Webscraper for The Glennie School (00496D)
CRICOS Provider: 00496D
Website: www.glennie.qld.edu.au
"""
...
PROVIDER_CODE = "00496D"
PROVIDER_NAME = r"The Glennie School"
SLUG = "glennie"
...
CSV_COURSES = [
  {
    "cricos": "004872G",
    "name": "Senior Secondary Years 11 to 12",
    "fee": "$132,871.00",
    "non_fee": "$67,235.00",
    "duration": "104"
  },
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.glennie.qld.edu.au",
