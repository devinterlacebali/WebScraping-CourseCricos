#!/usr/bin/env python3
"""
Webscraper for Blackheath and Thornburgh College (00488D)
CRICOS Provider: 00488D
Website: www.btc.qld.edu.au
"""
...
PROVIDER_CODE = "00488D"
PROVIDER_NAME = r"Blackheath and Thornburgh College"
SLUG = "btc"
...
CSV_COURSES = [
  {
    "cricos": "004846K",
    "name": "Secondary Junior Yrs 9-10 Boys & Girls",
    "fee": "$103,640.00",
    "non_fee": "$38,064.00",
    "duration": "104"
  },
  {
    "cricos": "004847J",
    "name": "Secondary Senior Yrs 11-12 Boys & Girls",
    "fee": "$108,620.00",
    "non_fee": "$38,064.00",
    "duration": "104"
  },
  {
    "cricos": "016451G",
    "name": "Secondary Junior Years 7-8 Boys & Girls",
    "fee": "$97,892.00",
    "non_fee": "$38,064.00",
    "duration": "104"
  },
