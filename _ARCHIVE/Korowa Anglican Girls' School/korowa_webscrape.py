"""
Korowa Anglican Girls' School - Web Scraper (01022G).
Data sources: https://www.korowa.vic.edu.au/enrolment/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01022G"
PROVIDER_NAME = "Korowa Anglican Girls' School"
...
INTL_URL = "https://www.korowa.vic.edu.au/enrolment/international"
