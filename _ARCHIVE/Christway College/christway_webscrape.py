"""
Christway College - Web Scraper (01894D).
Data sources: https://christway.vic.edu.au/enrolment/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01894D"
PROVIDER_NAME = "Christway College"
...
INTL_URL = "https://christway.vic.edu.au/enrolment/international"
WEBSITE = "https://christway.vic.edu.au"
