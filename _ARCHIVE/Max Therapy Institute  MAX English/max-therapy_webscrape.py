"""
Max Therapy Institute / MAX English - Web Scraper (03401C).
Data sources: https://www.mti.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03401C"
PROVIDER_NAME = "Max Therapy Institute / MAX English"
...
INTL_URL = "https://www.mti.vic.edu.au/courses"
WEBSITE = "https://www.mti.vic.edu.au"
