"""
Deakin College - Web Scraper (01590J).
Data sources: https://www.deakincollege.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01590J"
PROVIDER_NAME = "Deakin College"
...
INTL_URL = "https://www.deakincollege.edu.au/courses"
