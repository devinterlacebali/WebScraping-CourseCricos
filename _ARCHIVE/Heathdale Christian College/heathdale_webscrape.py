"""
Heathdale Christian College - Web Scraper (00578B).
Data sources: https://www.heathdale.vic.edu.au/international-students
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00578B"
PROVIDER_NAME = "Heathdale Christian College"
...
INTL_URL = "https://www.heathdale.vic.edu.au/international-students"
WEBSITE = "https://www.heathdale.vic.edu.au"
