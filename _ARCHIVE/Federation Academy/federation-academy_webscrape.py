"""
Federation Academy - Web Scraper (03980A).
Data sources: https://www.federationacademy.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03980A"
PROVIDER_NAME = "Federation Academy"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "federation-academy"
...
INTL_URL = "https://www.federationacademy.edu.au/courses"
WEBSITE = "https://www.federationacademy.edu.au"
