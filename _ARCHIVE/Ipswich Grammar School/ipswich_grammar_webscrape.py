#!/usr/bin/env python3
"""
Webscraper for Ipswich Grammar School (00499A)
CRICOS Provider: 00499A
...
PROVIDER_CODE = "00499A"
PROVIDER_NAME = r"Ipswich Grammar School"
SLUG = "ipswich_grammar"
...
CSV_COURSES = [
  {
    "cricos": "004881G",
    "name": "Secondary Senior Yrs 11-12 Boys Only",
    "fee": "$138,416.00",
    "non_fee": "$52,840.00",
    "duration": "104"
  },
  {
    "cricos": "082458J",
    "name": "Junior Secondary Years 7-10 Boys Only",
    "fee": "$261,392.00",
    "non_fee": "$99,950.00",
    "duration": "208"
  },
  {
    "cricos": "096712G",
    "name": "Primary School Studies Years P-6",
    "fee": "$242,925.00",
    "non_fee": "$20,000.00",
    "duration": "364"
  }
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.ipswichgrammar.com",
