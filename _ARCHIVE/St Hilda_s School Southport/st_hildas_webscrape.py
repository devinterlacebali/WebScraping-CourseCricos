#!/usr/bin/env python3
"""
Webscraper for St Hilda_s School Southport (00510M)
CRICOS Provider: 00510M
...
PROVIDER_CODE = "00510M"
PROVIDER_NAME = r"St Hilda_s School Southport"
SLUG = "st_hildas"
...
CSV_COURSES = [
  {
    "cricos": "004923B",
    "name": "Secondary Senior Years 11-12",
    "fee": "$160,068.00",
    "non_fee": "$69,698.00",
    "duration": "104"
  },
  ...
  {
    "cricos": "086183K",
    "name": "Secondary Junior Years 7-10",
    "fee": "$296,377.00",
    "non_fee": "$125,168.00",
    "duration": "208"
  }
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.sthildas.qld.edu.au",
