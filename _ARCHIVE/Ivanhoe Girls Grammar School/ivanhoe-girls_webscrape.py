"""
Ivanhoe Girls Grammar School - Web Scraper (00974A).
Data sources: https://www.ivanhoegirls.vic.edu.au/enrolment/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00974A"
PROVIDER_NAME = "Ivanhoe Girls Grammar School"
...
INTL_URL = "https://www.ivanhoegirls.vic.edu.au/enrolment/international"
WEBSITE = "https://www.ivanhoegirls.vic.edu.au"
