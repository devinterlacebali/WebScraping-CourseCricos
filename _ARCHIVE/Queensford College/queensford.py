"""
Queensford College — CSV-driven (provider 03010G).
Cloudflare (bypass curl_cffi). No sitemap. SSR listing page. Strategy: CSV-driven.
"""
import sys, re, csv
...
PROVIDER_NAME = 'Queensford College'
...
def main():
    ...
    out = [{
        ...
        'source': 'register', 'note': 'CSV-driven (Cloudflare, no sitemap)',
    } for r in rows]
