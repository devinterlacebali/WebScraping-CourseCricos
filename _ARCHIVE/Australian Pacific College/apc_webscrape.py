"""
Australian Pacific College - Web Scraper (01331F).
Data sources: https://www.apc.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01331F"
PROVIDER_NAME = "Australian Pacific College"
...
INTL_URL = "https://www.apc.edu.au/courses"
