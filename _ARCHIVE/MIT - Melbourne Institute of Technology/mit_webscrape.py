"""
MIT - Melbourne Institute of Technology - Web Scraper (01545C).
Data sources: https://www.mit.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01545C"
PROVIDER_NAME = "MIT - Melbourne Institute of Technology"
...
INTL_URL = "https://www.mit.edu.au/courses"
