"""
Melbourne Grammar School - Web Scraper (00977J).
Data sources: https://www.mgs.vic.edu.au/enrolment/fees
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00977J"
PROVIDER_NAME = "Melbourne Grammar School"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "melbourne-grammar"
...
INTL_URL = "https://www.mgs.vic.edu.au/enrolment/fees"
