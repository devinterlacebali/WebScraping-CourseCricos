"""
St Aloysius College - Web Scraper (00871G).
Data sources: https://www.aloysius.vic.edu.au/international-students
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00871G"
PROVIDER_NAME = "St Aloysius College"
...
INTL_URL = "https://www.aloysius.vic.edu.au/international-students"
WEBSITE = "https://www.aloysius.vic.edu.au"
