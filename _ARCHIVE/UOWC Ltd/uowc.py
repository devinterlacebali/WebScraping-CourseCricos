"""
UOWC Ltd (UOW College Australia) — www.uowcollege.edu.au.

Vue.js SPA (JS-loaded CRICOS/fee/starts).
Strategy: CSV-driven (provider 02723D, 20 courses).
"""
import sys, re, csv
...
PROVIDER_CODE = '02723D'
PROVIDER_NAME = 'UOWC Ltd (UOW College Australia)'
...
def main():
    ...
    out = [{
        ...
        'source': 'register', 'note': 'CSV-driven (SPA, no SSR)',
    } for r in rows]
