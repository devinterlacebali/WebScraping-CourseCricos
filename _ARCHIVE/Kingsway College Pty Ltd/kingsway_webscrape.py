"""
Kingsway College Pty Ltd - Web Scraper (03916J).
Data sources: https://www.kingswaycollege.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03916J"
PROVIDER_NAME = "Kingsway College Pty Ltd"
...
INTL_URL = "https://www.kingswaycollege.vic.edu.au/courses"
WEBSITE = "https://www.kingswaycollege.vic.edu.au"
