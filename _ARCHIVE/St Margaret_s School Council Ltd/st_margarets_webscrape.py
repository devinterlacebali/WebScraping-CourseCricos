#!/usr/bin/env python3
"""
Webscraper for St Margaret_s School Council Ltd (00511K)
CRICOS Provider: 00511K
...
PROVIDER_CODE = "00511K"
PROVIDER_NAME = r"St Margaret_s School Council Ltd"
SLUG = "st_margarets"
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.stmargarets.qld.edu.au",
