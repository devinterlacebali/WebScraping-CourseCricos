"""
Ballarat and Queen's Anglican Grammar — CSV-driven (provider 00129E).
"""
import sys, re, csv
...
PROVIDER_CODE = "00129E"
PROVIDER_NAME = "Ballarat and Queen's Anglican Grammar"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "ballarat-grammar"
...
def main():
    ...
    out = [{"cricos": r["cricos"], "title": r["title"], "url": "",
