#!/usr/bin/env python3
"""
Webscraper for Hutchins School Board of Management (00478F)
CRICOS Provider: 00478F
...
PROVIDER_CODE = "00478F"
PROVIDER_NAME = r"Hutchins School Board of Management"
SLUG = "hutchins"
...
CSV_COURSES = [
  {
    "cricos": "004729D",
    "name": "Secondary Junior Grades 7-12",
    "fee": "$464,443.00",
    "non_fee": "$203,162.00",
    "duration": "304"
  },
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.hutchins.tas.edu.au",
