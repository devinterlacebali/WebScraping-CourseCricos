"""
Mechanical Institute of Training and Technology - Web Scraper (03529J).
Data sources: https://www.mitt.vic.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03529J"
PROVIDER_NAME = "Mechanical Institute of Training and Technology"
...
INTL_URL = "https://www.mitt.vic.edu.au/courses"
WEBSITE = "https://www.mitt.vic.edu.au"
