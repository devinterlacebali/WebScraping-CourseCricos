"""
West Melbourne Institute of Technology - Web Scraper (03874C).
Data sources: https://www.wmit.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03874C"
PROVIDER_NAME = "West Melbourne Institute of Technology"
...
INTL_URL = "https://www.wmit.edu.au/courses"
WEBSITE = "https://www.wmit.edu.au"
