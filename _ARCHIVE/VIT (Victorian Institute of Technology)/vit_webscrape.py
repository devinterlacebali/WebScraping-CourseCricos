"""
VIT (Victorian Institute of Technology) - Web Scraper (02044E).
Data sources: https://www.vit.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "02044E"
PROVIDER_NAME = "VIT (Victorian Institute of Technology)"
...
INTL_URL = "https://www.vit.edu.au/courses"
