#!/usr/bin/env python3
"""
Webscraper for Brisbane Grammar School (00489C)
CRICOS Provider: 00489C
...
PROVIDER_CODE = "00489C"
PROVIDER_NAME = r"Brisbane Grammar School"
SLUG = "brisbane_grammar"
...
CSV_COURSES = [
  ...
  {
    "cricos": "084788G",
    "name": "Primary Studies Years 5 & 6 Boys Only",
    "fee": "$142,559.00",
    "non_fee": "$61,319.00",
    "duration": "104"
  }
...
def main():
    ...
    for c in csv_courses:
        ...
        results.append({
            "cricos": cricos,
            "title": name,
            "url": "https://www.brisbanegrammar.com",
