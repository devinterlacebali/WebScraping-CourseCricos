"""
Nazareth College - Web Scraper (01097M).
Data sources: https://www.nazareth.vic.edu.au/international-students
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01097M"
PROVIDER_NAME = "Nazareth College"
...
INTL_URL = "https://www.nazareth.vic.edu.au/international-students"
WEBSITE = "https://www.nazareth.vic.edu.au"
