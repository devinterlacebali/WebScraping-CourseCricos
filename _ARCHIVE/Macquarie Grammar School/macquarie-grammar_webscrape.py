"""
Macquarie Grammar School - Web Scraper (03330B).
Data sources: https://www.macquariegrammarschool.edu.au/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03330B"
PROVIDER_NAME = "Macquarie Grammar School"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "macquarie-grammar"
...
INTL_URL = "https://www.macquariegrammarschool.edu.au/international"
WEBSITE = "https://www.macquariegrammarschool.edu.au"
