"""
La Trobe College Australia - Web Scraper (03312D).
Data sources: https://www.latrobemelbourne.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "03312D"
PROVIDER_NAME = "La Trobe College Australia"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "la-trobe-college"
...
INTL_URL = "https://www.latrobemelbourne.edu.au/courses"
WEBSITE = "https://www.latrobemelbourne.edu.au"
