"""
IHNA (Health Careers International) — CSV-driven (provider 03386G).
Corporate site (HCI Group). Courses on IHNA domain. Strategy: CSV-driven.
"""
import sys, re, csv
...
PROVIDER_CODE = '03386G'
PROVIDER_NAME = 'IHNA (Health Careers International)'
...
def main():
    ...
    out = [{
        ...
        'source': 'register', 'note': 'CSV-driven (corporate site)',
    } for r in rows]
