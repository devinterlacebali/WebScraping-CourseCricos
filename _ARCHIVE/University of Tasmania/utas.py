"""
University of Tasmania (UTas) scraper — www.utas.edu.au.

Squiz Matrix CMS — no SSR course pages.
CSV-driven (219 courses, provider 00586B). SQL standard Deakin/JCU.
"""
...
PROVIDER_CODE = '00586B'
PROVIDER_NAME = 'University of Tasmania (UTas)'
