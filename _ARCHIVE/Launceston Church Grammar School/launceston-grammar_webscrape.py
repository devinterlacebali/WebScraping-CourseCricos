"""
Launceston Church Grammar School - Web Scraper (00650K).
Data sources: https://www.lcgs.tas.edu.au/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00650K"
PROVIDER_NAME = "Launceston Church Grammar School"
PROVIDER_DIR = Path(__file__).resolve().parent
SLUG = "launceston-grammar"
...
INTL_URL = "https://www.lcgs.tas.edu.au/international"
WEBSITE = "https://www.lcgs.tas.edu.au"
