"""
ETEA (Education Training & Employment Australia) — CSV-driven (provider 02925E).
No Cloudflare, no course sitemap. Strategy: CSV-driven.
"""
import sys, re, csv
...
PROVIDER_CODE = '02925E'
PROVIDER_NAME = 'ETEA (Education Training & Employment Australia)'
