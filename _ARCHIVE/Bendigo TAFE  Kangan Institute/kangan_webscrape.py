"""
Bendigo TAFE / Kangan Institute - Web Scraper (01218G).
Data sources: https://www.kangan.edu.au/international
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "01218G"
PROVIDER_NAME = "Bendigo TAFE / Kangan Institute"
...
INTL_URL = "https://www.kangan.edu.au/international"
