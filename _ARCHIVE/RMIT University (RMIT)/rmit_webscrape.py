"""
RMIT University (RMIT) - Web Scraper (00122A).
Data sources: https://www.rmit.edu.au/courses
"""
import sys, re, csv, requests
from pathlib import Path
sys.path = [p for p in sys.path if 'hermes' not in p.lower()]

PROVIDER_CODE = "00122A"
PROVIDER_NAME = "RMIT University (RMIT)"
...
INTL_URL = "https://www.rmit.edu.au/courses"
