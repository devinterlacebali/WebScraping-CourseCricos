...
UPDATE courses SET
    course_description = '<p>Understand the human mind and how it drives behaviour.</p><p>La Trobe''s Bachelor of Psychological Science will prepare you for a career as a professional psychologist, or in a psychology-related field across industries from clinical psychology to human services and marketing.</p><p>Elective subjects with a choice of minor sequences in Human Relationships and Neuroscience gives you the flexibility to work towards the career you want. </p><p><strong>You''ll learn:</strong></p><ul><li><strong>Analytical, research and communication skills</strong><ul><li>Learn skills that are essential to your future career in psychology.</li></ul></li><li><strong>Clinical and health psychology</strong><ul><li>Gain an understanding of how to help people cope with mental and physical disorders.</li></ul></li><li><strong>Developmental and social psychology</strong><ul><li>Understand how environmental factors contribute to peoples'' psychological makeup.</li></ul></li><li><strong>Psychological assessment, intervention and research</strong><ul><li>Become familiar with methods to understand and measure people''s psychological state.</li><li>Learn when and how to intervene and how to conduct research.</li></ul></li></ul><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 7 - Bachelor Degree.</p>',
    course_duration_per_week = 156,
...
UPDATE courses SET
    ...
    offshore_tuition_fee = 89600,
    onshore_tuition_fee = 44800,
    enrolment_fee = 0,
    materials_fee = NULL,
...
-- From CRICOS register fallback: Bachelor of Languages and Linguistics
UPDATE courses SET
    course_duration_per_week = 156,
...
UPDATE courses SET
    course_description = '<p>You will graduate from this degree as a midwife who is qualified to provide leadership in advanced clinical, management, research and academic aspects of the provision of health services.</p><p>You will possess a unique blend of abilities stemming from clinical experience, rigorous intellectual development and participation in the study of issues significant to midwifery. The degree offers an integrated program of research with supporting coursework in the first year. Through a combination of core and elective subjects, you will gain knowledge and skills in designing and conducting research, literature review techniques, critical analysis and writing for publication, as well as opportunities to apply these skills in clinical or professional projects of relevance to nursing.</p><p>The research component requires you to pursue an independent and sustained investigation into a research problem that will culminate in the submission of a thesis for examination of 60,000 words.</p><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 10 – Professional Doctorate.</p>',
    course_duration_per_week = 208,
    offshore_tuition_fee = 170400,
    onshore_tuition_fee = 42600,
    enrolment_fee = 0,
    materials_fee = NULL,
    entry_requirements = '<table><tbody><tr><td><strong>English Proficiency</strong></td><td>6.5 IELTS (Academic) with no individual band less than 6.0.</td></tr></tbody></table>',
...
UPDATE courses SET
    course_description = '<p><strong>Help others find their voice.</strong></p><p>Our ability to communicate clearly and enjoy food or drink are things we can take for granted. But people of all ages can experience difficulties and the effects can be devastating. Speech pathologists work to improve a person''s abilities, they also work to improve quality of life. Launch your career in this rewarding field of health with La Trobe''s Bachelor of Speech Pathology (Honours).</p><p>You''ll develop an understanding of the anatomy behind speech and swallowing impairments and provide therapeutic treatment and management options. Build hands-on skills with approximately 1,000 hours of placement on-campus and in clinics across Victoria. You''ll also learn how to improve speech pathology services and policies by tackling a fourth-year industry project or research thesis.</p><p><strong>You''ll learn:</strong></p><ul><li><strong>Therapeutic intervention and management</strong></li><li><ul><li>Design and manage the best course of treatment for patients with communication and swallowing impairments.</li></ul></li><li><strong>Anatomy and neurophysiology</strong></li><li><ul><li>Gain an understanding of the functional anatomy and neurophysiology relevant to communication and swallowing and their role in impairment.</li></ul></li><li><strong>The science of speech and hearing</strong></li><li><ul><li>Discover the latest techniques for investigating sound, speech, and hearing, including the analysis of sound waves and speech, and the psychology of sound perception.</li></ul></li></ul><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 8 – Bachelor Degree Honours</p>',
    course_duration_per_week = 208,
    offshore_tuition_fee = 209600,
...
UPDATE courses SET
    course_description = '<p>Build a strong foundation in science while exploring disciplines, majors and career pathways with La Trobe University''s Bachelor of Science. </p><p>In this degree, you will study scientific concepts and learn how scientists think, work, test ideas and share their findings. You will explore areas such as data analysis, research, sustainability and emerging technologies, including artificial intelligence. You will then apply your learning through laboratories, fieldwork, industry projects and work-integrated learning opportunities. </p><p>You can shape your degree through majors, minors or a double major, with pathways into Honours, postgraduate study, research and science-related careers. Depending on your campus and study mode, you could choose from up to 18 majors, 24 minors and a wide range of electives. </p><p>Along the way, you''ll develop transferable skills in critical thinking, data analysis and applying scientific methods with precision, preparing you for science-related careers, roles beyond traditional science fields and opportunities across a wide range of industries. </p><p><strong>By studying the Bachelor of Science, you will learn how to:</strong></p><ul><li>analyse scientific problems using evidence, data and discipline knowledge </li></ul><ul><li>apply laboratory, fieldwork and research skills in practical scientific contexts </li></ul><ul><li>interpret data and communicate findings for professional and non-specialist audiences </li></ul><ul><li>evaluate scientific approaches across areas such as biotechnology, environmental science, pharmaceuticals and research </li></ul><ul><li>design solutions to real-world problems through collaboration, projects and applied learning </li></ul><ul><li>assess your study direction through majors, minors, double-major options and further study pathways. </li></ul><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 7 - Bachelor Degree.</p>',
    course_duration_per_week = 156,
    offshore_tuition_fee = 129000,
    onshore_tuition_fee = 43000,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Graduate Diploma in Information Technology
UPDATE courses SET
...
UPDATE courses SET
    course_description = '<p>If you''re a practitioner in clinical sciences in: Occupational Therapy, Physiotherapy, Prosthetics and Orthotics, Podiatry, Speech Pathology, Audiology, Orthoptics, or Food, Nutrition and Dietetics, this degree provides you with an opportunity to extend your professional practice through an integrated program of theory, practice and research.</p><p>The degree offers an integrated program of research with supporting coursework in the first year. Through a combination of core and elective subjects, you''ll gain knowledge and skills in designing and conducting research, literature review techniques, critical analysis and writing for publication, as well as opportunities to apply these skills in clinically-based professional projects.</p><p>You''ll pursue an independent and sustained investigation into a research problem that will culminate in the submission of a thesis for examination of 60,000 words.</p><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 10 – Professional Doctorate.</p>',
    course_duration_per_week = 208,
    offshore_tuition_fee = 180000,
    onshore_tuition_fee = 45000,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Master of Health Information Management
UPDATE courses SET
    course_duration_per_week = 104,
...
-- From CRICOS register fallback: Master of Psychological Science
UPDATE courses SET
    course_duration_per_week = 104,
    offshore_tuition_fee = 89200,
    enrolment_fee = 0,
    apply_form = 'https://www.latrobe.edu.au/courses/master-of-psychological-science',
    updated_at = NOW()
WHERE cricos_course_code = '071896M';

UPDATE courses SET
    course_description = '<p>The Master''s by research degree requires you to deepen your knowledge of your discipline area and develop advanced skills in the conduct of independent and sustained research. As a Master''s by research candidate, you will undertake a supervised research project that culminates in the submission of a thesis for examination. Upon completion of your candidature you must demonstrate through your thesis that you have acquired an advanced and integrated understanding of a complex body of knowledge in one or more disciplines.</p><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 9 – Masters Degree by Research.</p>',
    course_duration_per_week = 104,
    offshore_tuition_fee = 89200,
    onshore_tuition_fee = 44600,
    enrolment_fee = 0,
...
UPDATE courses SET
    ...
    course_duration_per_week = 104,
    offshore_tuition_fee = 105200,
    onshore_tuition_fee = 52600,
    enrolment_fee = 0,
    materials_fee = NULL,
...
-- From CRICOS register fallback: Graduate Diploma in Business Administration
UPDATE courses SET
    course_duration_per_week = 52,
...
-- From CRICOS register fallback: Graduate Certificate in Business Administration
UPDATE courses SET
...
-- From CRICOS register fallback: Graduate Certificate in Information Technology Fundamentals
UPDATE courses SET
    course_duration_per_week = 26,
...
-- From CRICOS register fallback: Graduate Diploma in Artificial intelligence 
UPDATE courses SET
    course_duration_per_week = 52,
    offshore_tuition_fee = 43800,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Diploma of Information Technology
UPDATE courses SET
    course_duration_per_week = 52,
    offshore_tuition_fee = 42000,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Diploma of Teacher Education
UPDATE courses SET
    course_duration_per_week = 52,
...
-- From CRICOS register fallback: Graduate Certificate in Data Science Fundamentals
UPDATE courses SET
    course_duration_per_week = 26,
    offshore_tuition_fee = 21900,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Graduate Certificate in Business Analytics
UPDATE courses SET
    course_duration_per_week = 26,
    offshore_tuition_fee = 21900,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Master of Strength and Conditioning
UPDATE courses SET
    course_duration_per_week = 78,
    offshore_tuition_fee = 69900,
    enrolment_fee = 0,
    apply_form = 'https://www.latrobe.edu.au/courses/master-of-strength-and-conditioning',
    updated_at = NOW()
WHERE cricos_course_code = '113592J';

-- From CRICOS register fallback: Bachelor of Food and Nutrition
UPDATE courses SET
    course_duration_per_week = 156,
...
-- From CRICOS register fallback: Master of Counselling, Rehabilitation and Mental Health
UPDATE courses SET
    course_duration_per_week = 104,
    offshore_tuition_fee = 86000,
    enrolment_fee = 0,
...
UPDATE courses SET
    course_description = '<p>Get the skills, knowledge and industry you need to launch a legal career in the world of scientific advancement with La Trobe''s Bachelor of Laws (Honours)/Bachelor of Biomedicine.</p><p>In this double degree, you''ll develop a solid legal grounding in the fundamentals of legal practice, and hone your skillset in advocacy, negotiation and dispute resolution through intellectual and skills-based training. At the same time, you''ll explore how the body works as you build essential knowledge in chemistry, bioscience and health.</p><p>By studying La Trobe''s Bachelor of Laws (Honours)/Bachelor of Biomedicine, you will:</p><ul><li>explore legal topics such as dispute resolution, evidence and criminal procedure, contract law and company law, and public law</li><li>develop foundational knowledge in biochemistry, molecular and cell biology, human physiology, infectious and non-communicable disease</li><li>choose a biomedicine major in cancer, heart and brain diseases; immunology and infectious disease; physiology and pharmacology; or molecular and cellular biochemistry</li><li>get hands-on experience through legal placements in community legal centres, law firms, government agencies and more, and build relationships with judges, magistrates and coroners</li><li>gain practical biomedical experience with lab work, field work, internship opportunities and overseas exchange opportunities.</li></ul><p>The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 8 – Bachelor Degree Honours.</p>',
    course_duration_per_week = 286,
    offshore_tuition_fee = 239800,
    onshore_tuition_fee = 43600,
    enrolment_fee = 0,
    materials_fee = NULL,
    entry_requirements = '<table><tbody><tr><td><strong>Academic Requirements</strong></td><td>Units 3 and 4: a study score of at least 30 in English (EAL) or at least 25 in English other than EAL.</td></tr><tr><td><strong>English Proficiency</strong></td><td>6.5 IELTS (Academic) with no individual band less than 6.0.</td></tr></tbody></table>',
...
-- From CRICOS register fallback: Graduate Diploma in Cybersecurity 
UPDATE courses SET
    course_duration_per_week = 52,
    offshore_tuition_fee = 43800,
    enrolment_fee = 0,
...
-- From CRICOS register fallback: Graduate Certificate in Public Health
UPDATE courses SET
    course_duration_per_week = 26,
